Mapmodel reworked and optimized by DES|Cleaner using MilkShape3D
Welded vertices reduced to: 170
Converted from (18Kb).md2 to (8Kb).md3

DES|Cleaner contact details:
	* http://ac-akimbo.net
	* http://assault.cubers.net/forum/user-420.html
	* http://forums.des-clan.net/
	* shamelessarts@gmail.com


		
ORIGINAL READ.ME TEXT
---------------------
model:      rusty barrel (barrel6)
